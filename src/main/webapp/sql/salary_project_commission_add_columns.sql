...
alter table salary_project_commission add purchase_agent_contract_fee decimal(4,4);
alter table salary_project_commission add purchasing_cost  decimal(4,4);
alter table salary_project_commission add commission_base  decimal(4,4);
alter table salary_project_commission add design_commission  decimal(4,4);
